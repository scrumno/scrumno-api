...
type AppConfig struct {
	...
	OpenAt             string     `gorm:"column:open_at;type:varchar(5);not null;default:'10:00'"  json:"open_at"`
	CloseAt            string     `gorm:"column:close_at;type:varchar(5);not null;default:'22:00'" json:"close_at"`
