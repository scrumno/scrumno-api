...
type OrderItem struct {
	...
	ProductID        uint      `gorm:"not null;index:idx_queue_estimation_item_product_id" json:"product_id"`
...
func NewOrderItem(orderID uuid.UUID, productID uint, quantity int, baseCookMinutes int, growthFactor float64, complexityFactor float64) *OrderItem {
	return &OrderItem{
		ID:               uuid.New(),
		OrderID:          orderID,
		ProductID:        productID,
